...
const SLOT_SYMBOLS = ["🦈", "🌊", "🧜", "🗺", "🌟"];
// Base bonus chances. Mini (Lucky Current) and shark hold at 10 / 8; minor /
// major / jackpot each get another +1 (minor 7→8, major 3→4, jackpot 2→3).
const SLOT_OUTCOMES = [
  { tier: "none",    weight: 67, pick: () => slotNonMatch() },
  { tier: "shark",   weight: 8,  pick: () => ["🦈", "🦈", "🦈"] },
  { tier: "mini",    weight: 10, pick: () => ["🌊", "🌊", "🌊"] },
  { tier: "minor",   weight: 8,  pick: () => ["🧜", "🧜", "🧜"] },
  { tier: "major",   weight: 4,  pick: () => ["🗺", "🗺", "🗺"] },
  { tier: "jackpot", weight: 3,  pick: () => ["🌟", "🌟", "🌟"] },
];
const SLOT_BONUSES = {
