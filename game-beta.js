...
const GEAR_DEFS = [
  ...
  // without being a wall for early players or a max-by-lvl-200 cakewalk.
  {
    ...
    icon: "🛡",
    desc: "Hazard duration (Shark Attack) reduced",
  ...
  {
    id: "stabilizer",
    name: "Bonus Stabilizer",
    icon: "✨",
    desc: "Positive slot bonuses last longer",
  ...
  {
    id: "luck",
    name: "Lucky Salvage Charm",
    icon: "🍀",
    desc: "Slot Machine luck — sharks shrink, jackpots and majors swell",
  ...
  {
    id: "insight",
    name: "Salvager's Insight",
    icon: "🧠",
    desc: "Bonus XP from every loot pickup and chest",
...
// Beta defaults to the main-game pearl 🔮; themed events (e.g. Spring
// Bloom) opt into a different emoji by setting EVENT_CONFIG.pearlEmoji.
...
const SLOT_BONUSES = (EVENT && EVENT.slotBonuses) || {
  ...
  minor:   { icon: "🧜", name: "Mermaid's Kiss",desc: "10× value & 10× XP for 15s.", valueMult: 10, xpMult: 10, duration: 15000 },
